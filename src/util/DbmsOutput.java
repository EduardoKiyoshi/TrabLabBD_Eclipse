...
*
*/
public DbmsOutput( Connection conn, String cpf) throws SQLException
{
...
public static void main (String args []) throws SQLException
{
    ...
    DbmsOutput dbmsOutput = new DbmsOutput( conn , "514.106.873-04");

    dbmsOutput.enable( 1000000 );
    
    stmt.execute
    ( "begin gerarRelatorioFunc('514.106.873-04'); end;" );
    stmt.close();
